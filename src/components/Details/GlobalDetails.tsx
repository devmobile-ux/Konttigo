...
// Global plans (UPDATED)
const plans = [
  { duration: "7 days", data: "1 GB", price: 8.99 },
  { duration: "15 days", data: "2 GB", price: 16.49 },
  { duration: "60 days", data: "3 GB", price: 33.99 },
  { duration: "180 days", data: "5 GB", price: 56.99 },
  { duration: "365 days", data: "10 GB", price: 66.99 },
];
                ...
                <div className="p-5">
                  ...
                  <div className="flex gap-3 mb-4">
                    ...
                    <div className="flex items-center gap-2 bg-gray-100 px-4 py-3 rounded-xl text-sm">
                      ...
                      <div>
                        ...
                        <p className="font-medium">167 Countries and Networks</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between bg-gray-100 px-4 py-3 rounded-xl text-sm mb-4 cursor-pointer">
                    <div className="flex items-center gap-2">
                      ...
                      <span>167 Countries and Networks</span>
                    </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="border-[1.5px] border-primary-400 rounded-[28px] p-6 bg-gradient-to-b from-[#FFF7F0] to-white">
              ...
              <p className="text-sm text-gray-700 leading-relaxed whitespace-pre-line">
                Start your trip by getting an eSIM for Global use and avoid sky-high roaming charges! Whether you’re exploring as a tourist or closing business deals, stay connected in Sri Lanka with a prepaid eSIM.
              </p>
              <p className="text-sm text-gray-700 leading-relaxed whitespace-pre-line">
